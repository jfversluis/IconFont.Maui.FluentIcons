...
using IconFont.Maui.FluentIcons.SourceGenerator;
using Xunit;
using System.Text;
using System.Collections.Generic;
using System.Threading;

namespace IconFont.Maui.FluentIcons.SourceGenerator.Tests;
...
public class GeneratorTests
{
    ...
    {
        var fontPath = Path.GetFullPath(Path.Combine(GetRepoRoot(), "src/IconFont.Maui.FluentIcons/Resources/Fonts/FluentSystemIcons-Regular.ttf"));
            ...
            optionsProvider: TestAnalyzerConfigOptionsProvider.With(
                perFile: new()
                {
                    [fontPath] = new()
                    {
                        ...
                        ["build_metadata.AdditionalFiles.IconFontNamespace"] = "IconFont.Maui.FluentIcons",
                    }
                }));
        ...
        Assert.Contains("namespace IconFont.Maui.FluentIcons;", text);
    ...
    public void Generates_Multiple_Fonts()
    {
        ...
        var regular = Path.GetFullPath(Path.Combine(root, "src/IconFont.Maui.FluentIcons/Resources/Fonts/FluentSystemIcons-Regular.ttf"));
        var filled = Path.GetFullPath(Path.Combine(root, "src/IconFont.Maui.FluentIcons/Resources/Fonts/FluentSystemIcons-Filled.ttf"));
    ...
    private static string GetRepoRoot()
    {
        ...
        while (dir != null && !File.Exists(Path.Combine(dir.FullName, "IconFont.Maui.FluentIcons.sln")))
            dir = dir.Parent!;
