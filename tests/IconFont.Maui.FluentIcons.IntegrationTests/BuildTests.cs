...
namespace IconFont.Maui.FluentIcons.IntegrationTests;
...
public class BuildTests
{
    ...
    public void Generates_Config_Files_On_Build()
    {
        ...
        var proj = Path.Combine(repoRoot, "src", "IconFont.Maui.FluentIcons", "IconFont.Maui.FluentIcons.csproj");
        ...
        var objRoot = Path.Combine(repoRoot, "src", "IconFont.Maui.FluentIcons", "obj");
